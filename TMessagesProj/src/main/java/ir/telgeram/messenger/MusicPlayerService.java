...
public class MusicPlayerService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static final String NOTIFY_PREVIOUS = "ir.telgeram.android.musicplayer.previous";
    public static final String NOTIFY_CLOSE = "ir.telgeram.android.musicplayer.close";
    public static final String NOTIFY_PAUSE = "ir.telgeram.android.musicplayer.pause";
    public static final String NOTIFY_PLAY = "ir.telgeram.android.musicplayer.play";
    public static final String NOTIFY_NEXT = "ir.telgeram.android.musicplayer.next";
