...
package ir.telgeram.messenger.browser;
...
import ir.telgeram.messenger.ShareBroadcastReceiver;
import ir.telgeram.messenger.support.customtabs.CustomTabsCallback;
import ir.telgeram.messenger.support.customtabs.CustomTabsClient;
import ir.telgeram.messenger.support.customtabs.CustomTabsIntent;
import ir.telgeram.messenger.support.customtabs.CustomTabsServiceConnection;
import ir.telgeram.messenger.support.customtabs.CustomTabsSession;
import ir.telgeram.messenger.support.customtabsclient.shared.CustomTabsHelper;
import ir.telgeram.messenger.support.customtabsclient.shared.ServiceConnection;
import ir.telgeram.messenger.support.customtabsclient.shared.ServiceConnectionCallback;
    ...
    public static void openUrl(Context context, Uri uri, boolean allowCustom) {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= 15 && allowCustom && MediaController.getInstance().canCustomTabs() && !internalUri && !scheme.equals("tel")) {
                ...
                builder.setToolbarColor(ThemeChanger.getcurrent().getActionbarcolor()); // Adel
