...
public class AudioCell extends FrameLayout {
    ...
    public AudioCell(Context context) {
        ...
        genreTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // Adel
        ...
        authorTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // Adel
        ...
        timeTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // Adel
