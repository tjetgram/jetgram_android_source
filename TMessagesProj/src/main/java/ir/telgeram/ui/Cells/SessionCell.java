...
public class SessionCell extends FrameLayout {
    ...
    public SessionCell(Context context) {
        ...
        onlineTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // Adel
        ...
        detailTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // Adel
        ...
        detailExTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // Adel
