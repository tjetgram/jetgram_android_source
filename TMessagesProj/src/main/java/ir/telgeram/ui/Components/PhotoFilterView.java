...
public class PhotoFilterView extends FrameLayout {
    ...
    public PhotoFilterView(Context context, Bitmap bitmap, int rotation) {
        ...
        infoTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // Adel
        ...
        paramTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // Adel
        ...
        valueTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // Adel
        ...
        blurOffButton.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // Adel
        ...
        blurRadialButton.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // Adel
        ...
        blurLinearButton.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // Adel
