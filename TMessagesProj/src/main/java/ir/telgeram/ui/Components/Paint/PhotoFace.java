package ir.telgeram.ui.Components.Paint;
...
public class PhotoFace {
    ...
    private ir.telgeram.ui.Components.Point foreheadPoint;

    private ir.telgeram.ui.Components.Point eyesCenterPoint;
    private float                           eyesDistance;

    private ir.telgeram.ui.Components.Point mouthPoint;
    private ir.telgeram.ui.Components.Point chinPoint;

    public PhotoFace(Face face, Bitmap sourceBitmap, Size targetSize, boolean sideward) {
        List<Landmark> landmarks = face.getLandmarks();

        ir.telgeram.ui.Components.Point leftEyePoint  = null;
        ir.telgeram.ui.Components.Point rightEyePoint = null;

        ir.telgeram.ui.Components.Point leftMouthPoint  = null;
        ir.telgeram.ui.Components.Point rightMouthPoint = null;
        ...
        if (leftEyePoint != null && rightEyePoint != null) {
            eyesCenterPoint = new ir.telgeram.ui.Components.Point(0.5f * leftEyePoint.x + 0.5f * rightEyePoint.x,
            ...
            foreheadPoint = new ir.telgeram.ui.Components.Point(eyesCenterPoint.x + foreheadHeight * (float)Math.cos(upAngle),
                                                                eyesCenterPoint.y + foreheadHeight * (float)Math.sin(upAngle));
        }

        if (leftMouthPoint != null && rightMouthPoint != null) {
            mouthPoint = new ir.telgeram.ui.Components.Point(0.5f * leftMouthPoint.x + 0.5f * rightMouthPoint.x,
            ...
            chinPoint = new ir.telgeram.ui.Components.Point(mouthPoint.x + chinDepth * (float)Math.cos(downAngle),
    ...
    private ir.telgeram.ui.Components.Point transposePoint(PointF point, Bitmap sourceBitmap, Size targetSize, boolean sideward) {
        ...
        return new ir.telgeram.ui.Components.Point(targetSize.width * point.x / bitmapW,
                                                   targetSize.height * point.y / bitmapH);
    }

    public ir.telgeram.ui.Components.Point getPointForAnchor(int anchor) {
        switch (anchor) {
            case 0: {
