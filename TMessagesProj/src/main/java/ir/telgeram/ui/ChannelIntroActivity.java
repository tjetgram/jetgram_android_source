...
public class ChannelIntroActivity extends BaseFragment
{
    ...
    public View createView(Context context) {
        ...
        whatIsChannelText.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // Adel
        ...
        descriptionText.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // Adel
