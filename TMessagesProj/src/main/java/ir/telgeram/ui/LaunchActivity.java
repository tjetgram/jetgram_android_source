...
import ir.telgeram.ui.contactsChanges.UpdateActivity;
	...
	private boolean handleIntent(Intent intent, boolean isNew, boolean restore, boolean fromPassword)
	{
		if(intent.hasExtra("channellink")&&intent.getStringExtra("channellink")!=null){
			if(intent.hasExtra("text")&&intent.getStringExtra("text")!=null){
				Setting2.setCurrentJoiningChannel(intent.getStringExtra("channellink"));
				...
				builder.setPositiveButton(LocaleController.getString("OK", R.string.OK).toUpperCase(), new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialogInterface, int i) {
						...
						Browser.openUrl(LaunchActivity.this, "tg://resolve?domain=" +Setting2.getCurrentJoiningChannel());
						Intent p2= new Intent(LaunchActivity.this,LaunchActivity.class);
						p2.putExtra("channellink", Setting2.getCurrentJoiningChannel());
						startActivity(p2);
				...
				Browser.openUrl(this, "tg://resolve?domain=" +  Setting2.getCurrentJoiningChannel());
			}
		}
